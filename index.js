...
app.post("/:usertype/register",function(req,res)
{
    ...
    if(userType == 'tutor')
    {
        ...
        qrystr = "Insert into Tutor (F_Name, L_Name, Email, Phone, City, Qualification, Experience) VALUES (\""+req.body.fname+"\", \""+req.body.lname+"\",\""+req.body.email+"\", "+req.body.contact+",\""+req.body.city+"\", \""+req.body.qualification+"\", "+req.body.experience+")";
        console.log(qrystr);
        pool.query(qrystr, function(error, results, fields) 
        {   
            if(error) throw error;
